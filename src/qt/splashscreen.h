...
#ifndef COUNOSH_QT_SPLASHSCREEN_H
#define COUNOSH_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. CounosH Core initialization
...
#endif // COUNOSH_QT_SPLASHSCREEN_H
