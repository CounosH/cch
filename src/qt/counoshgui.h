...
#ifndef COUNOSH_QT_COUNOSHGUI_H
#define COUNOSH_QT_COUNOSHGUI_H
...
/**
  CounosH GUI main class. This class represents the main window of the CounosH UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CounosHGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CounosHGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~CounosHGUI();
