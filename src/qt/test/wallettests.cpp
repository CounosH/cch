...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CounosHAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_counosh-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_counosh-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_counosh-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = CounosHUnits::formatWithUnit(unit, balance, false, CounosHUnits::separatorAlways);
    ...
    // Amount input
    CounosHAmountField* amountInput = receiveCoinsDialog.findChild<CounosHAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: counosh:")) != -1);
