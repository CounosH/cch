    ...
    platformStyle(_platformStyle)
{
    ...
    // normal counosh address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying counosh address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CounosHAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
