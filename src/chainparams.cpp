...
// Copyright (c) 2009-2019 The Counos Core developers
...
{
    const char* pszTimestamp = "Pandemic very much at the top of Swiss worry list";
...
public:
    CMainParams() {
       strNetworkID = CBaseChainParams::MAIN;
        consensus.nSubsidyHalvingInterval = 18888888;
        ...
        genesis = CreateGenesisBlock(1609277693, 2207389899, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000000044cec36c60bbad7ef235cccda32c2c7a476d31b0e9fecdbee6ddc0d7"));
        assert(genesis.hashMerkleRoot == uint256S("0x4493e92b56cd8c5ca8246f10688f3f50141b9aa9ebf6862f05c522f0e077a613"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x15, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x15, 0x88, 0xAD, 0xE4};
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6821a16c93bb33d1ca1abd6fccfadc5e588b10133a8a0ccbca68c7043d8b3be7"));
        assert(genesis.hashMerkleRoot == uint256S("0x4493e92b56cd8c5ca8246f10688f3f50141b9aa9ebf6862f05c522f0e077a613"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.counos.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.counos.sprovoost.nl");
