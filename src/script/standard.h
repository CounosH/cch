...
#ifndef COUNOSH_SCRIPT_STANDARD_H
#define COUNOSH_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a counosh address
 */
...
/**
 * Generate a CounosH scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // COUNOSH_SCRIPT_STANDARD_H
