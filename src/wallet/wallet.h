...
#ifndef COUNOSH_WALLET_WALLET_H
#define COUNOSH_WALLET_WALLET_H
...
//! -maxtxfee default
constexpr CAmount DEFAULT_TRANSACTION_MAXFEE{COIN * 3 };
...
public:
     ...
     * on this counosh node, and set to 0 for transactions that were created
